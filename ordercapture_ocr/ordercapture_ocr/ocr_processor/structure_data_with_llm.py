                ...
                "properties": {
                    ...
                    "Customer": {
                        ...
                        "properties": {
                            ...
                            "customerAddress": {
                                "type": "string",
                                "description": "Delivered to Address of the customer or Billing Address of the customer if Delivered to Address is not available.",
                            },
                        },
                        "required": [
                            "customerAddressLink",
                    ...
                    "orderDetails": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                "itemCode": {
                                    "type": "string",
                                    "description": "Code identifying the item.",
                                },
                                "itemName": {
                                    "type": "string",
                                ...
                                "gst": {
                                    "type": "number",
                                    "description": "GST rate for the item.",
                                },
                                "landing_rate": {
                                    "type": "number",
                                    "description": "Rate of the item with all taxes and charges.",
                                },
                                "totalAmount": {
                                    "type": "number",
                                    "description": "Total amount for the item including GST.",
                                },
                            },
                            "required": [
                                "itemCode",
                    ...
                    "totals": {
                        ...
                        "properties": {
                            ...
                            "itemGrandTotal": {
                                "type": "number",
                                "description": "Grand total amount for all items.",
                            },
                        },
